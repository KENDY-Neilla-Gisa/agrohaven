...
const Home = () => {
  return (
    <div className="overflow-hidden">
      {/* Hero Section */}
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 bg-white dark:bg-gray-900">
          ...
          <div className="flex flex-col lg:flex-row items-center">
            <div className="lg:w-1/2 mb-12 lg:mb-0">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6 text-gray-900 dark:text-white">
                Grow Fresh Food <br />
                <span className="text-primary-600 dark:text-primary-400">Indoors</span> All Year Round
              </h1>
            ...
            <div className="lg:w-1/2">
              <div className="relative">
                <div className="bg-primary-100 dark:bg-gray-800/50 rounded-3xl p-8 transform rotate-2 backdrop-blur-sm">
                  <img 
                ...
                <div className="absolute -bottom-6 -right-6 bg-white dark:bg-gray-800 p-4 rounded-2xl shadow-lg">
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-800">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 dark:text-white">Smart Indoor Gardening Made Simple</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="bg-white/90 dark:bg-gray-700/80 backdrop-blur-sm p-8 rounded-2xl border border-gray-100 dark:border-gray-600 shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1">
                <div className="w-16 h-16 rounded-full bg-primary-600 flex items-center justify-center mb-6 mx-auto">
                  {feature.icon}
                </div>
                <h3 className="text-xl font-semibold mb-3 text-gray-800 dark:text-white text-center">{feature.title}</h3>
      ...
      <section className="py-20 bg-primary-700 dark:bg-primary-800 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <a 
            href="#" 
            className="inline-flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-primary-700 dark:text-primary-900 bg-white hover:bg-gray-100 dark:hover:bg-gray-200 md:py-4 md:text-lg md:px-10 cursor-pointer transition-colors duration-200"
          >
            Shop Now
          </a>
        </div>
